# Generated by Django 5.2.1 on 2025-05-31 14:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('admin', 'Admin'), ('member', 'Member')], default='member', help_text='Type of user: Admin or Member', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genre', models.CharField(help_text='Genre of the book', max_length=50)),
